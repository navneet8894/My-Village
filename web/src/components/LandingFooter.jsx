...
export default function LandingFooter() {
  return (
    <footer className="border-t border-line bg-elevated text-text-muted">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="sm:col-span-2 lg:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-lg text-text">MY VILLAGE</span>
            </div>
          ...
          <div>
            <h3 className="font-semibold text-text mb-3">Platform</h3>
          ...
          <div>
            <h3 className="font-semibold text-text mb-3">Community</h3>
            <ul className="space-y-2 text-sm">
          ...
          <div>
            <h3 className="font-semibold text-text mb-3">Get started</h3>
            <ul className="space-y-2 text-sm">
              <li>
        ...
        <div className="mt-10 pt-6 border-t border-line flex flex-col sm:flex-row justify-between items-center gap-4 text-sm text-text-subtle">
